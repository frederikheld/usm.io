...
describe('story', function () {
    ...
    describe('Story.prototype.render()', function () {
        context('valid data was passed to the constructor', function () {
            it('renders an empty Story, if the object is empty', async function () {
            ...
            it('renders a Story card if title and/or description are given', async function () {
                const story = new Story({
                    title: 'Awesome Story'
                }, {})

                let htmlRendered = story.render()
                let htmlExpected = await fs.readFile(path.join(__dirname, 'mock-data', 'story', 'mock-story-title-only.html'), 'utf8')
                ...
                let htmlRendered2 = story2.render()
                let htmlExpected2 = await fs.readFile(path.join(__dirname, 'mock-data', 'story', 'mock-story-description-only.html'), 'utf8')
